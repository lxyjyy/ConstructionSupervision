...
@ActivityScope
public class TabMsgPresenter extends BasePresenter<TabMsgContract.Model, TabMsgContract.View> {
    ...
    @Inject
    public TabMsgPresenter(TabMsgContract.Model model, TabMsgContract.View rootView
