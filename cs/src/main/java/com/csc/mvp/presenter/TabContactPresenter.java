...
@ActivityScope
public class TabContactPresenter extends BasePresenter<TabContactContract.Model, TabContactContract.View> {
    ...
    @Inject
    public TabContactPresenter(TabContactContract.Model model, TabContactContract.View rootView
