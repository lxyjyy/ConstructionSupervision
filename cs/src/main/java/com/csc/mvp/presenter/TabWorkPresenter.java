...
@ActivityScope
public class TabWorkPresenter extends BasePresenter<TabWorkContract.Model, TabWorkContract.View> {
    ...
    @Inject
    public TabWorkPresenter(TabWorkContract.Model model, TabWorkContract.View rootView
