...
@ActivityScope
public class TabContactModel extends BaseModel<ServiceManager, CacheManager> implements TabContactContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public TabContactModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
