...
@ActivityScope
public class TabWorkModel extends BaseModel<ServiceManager, CacheManager> implements TabWorkContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public TabWorkModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
