...
@ActivityScope
public class TabMineModel extends BaseModel<ServiceManager, CacheManager> implements TabMineContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public TabMineModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
