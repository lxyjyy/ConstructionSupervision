...
@ActivityScope
public class TabMsgModel extends BaseModel<ServiceManager, CacheManager> implements TabMsgContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public TabMsgModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
