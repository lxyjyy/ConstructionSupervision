...
import com.csc.listener.MyPacketListener;
import com.csc.listener.TaxiConnectionListener;
...
public class XmppConnectionUtil {  
	 ...
	 private String SERVER_HOST = "120.26.61.160";//测试
	    public static String SERVER_NAME = "doctorg";
	    
//	    private String SERVER_HOST = "121.43.227.82";//正式
//	    public static String SERVER_NAME = "doctorg";
    
    private int SERVER_PORT = 5222;
    private XMPPConnection connection = null;  
    private static XmppConnectionUtil xmppConnection;  
    ...
    synchronized public static XmppConnectionUtil getInstance() {
    	if (xmppConnection == null) {
    		xmppConnection = new XmppConnectionUtil();
		}
        return xmppConnection;  
    }
    
    private XmppConnectionUtil(){//初始 
//    	connectionListener = new TaxiConnectionListener();
//    	packetListener = new MyPacketListener(UiCommon.INSTANCE.getCurrActivity());//添加消息接收监听器
    }
...
//                SmackAndroid.init(UiCommon.INSTANCE.getCurrActivity());
...
//		ServiceDiscoveryManager.setIdentityType("phone");
    ...
    public boolean login(String account, String password) {
    	try {
    		if (getConnection().isConnected()) {
    			...
    			getConnection().addPacketListener(packetListener, null);
			}else {
				return false;
			}
     ...
     */ 
    public String regist(String account, String password, String nickname, String email) {
